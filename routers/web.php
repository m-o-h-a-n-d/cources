...
$router->get('/logout', [JwtAuthController::class, 'logout']);
...
$router->get('/student/login', [JwtAuthController::class, 'studentLoginForm']);
$router->post('/student/login', [JwtAuthController::class, 'studentLogin']);

$router->get('/admin/login', [JwtAuthController::class, 'adminLoginForm']);
$router->post('/admin/login', [JwtAuthController::class, 'adminLogin']);
